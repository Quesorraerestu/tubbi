function onCreate()
	...
	scaleObject('sewer', 0.7, 0.7);
        addLuaSprite('sewer', false)

	makeLuaSprite('light', 'sewer/light', -600, -130);
	...
	makeLuaSprite('overlay', 'sewer/overlaygnw', -170, -90);
	...
	makeAnimatedLuaSprite('NB_left','sewer/NB_left', -550, 160) 
    addAnimationByPrefix('NB_left','idle','NB_Idle',24,true)
    addLuaSprite('NB_left', false);
	scaleObject('NB_left', 0.34, 0.34);
	setScrollFactor('NB_left', 0.9, 0.9);
        setProperty('NB_left.alpha', 0);
